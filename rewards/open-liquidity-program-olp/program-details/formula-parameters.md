...
| $$MaxSpread$$ |  Maximum allowable spread against mid-price[^2] in an order to generate points for [Total Score](scoring-formula-methodology.md#total-score)  | 50 bps[^3] for BTC and ETH perp markets, 100 bps for all other eligible markets |
