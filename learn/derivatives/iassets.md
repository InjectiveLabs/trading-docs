...
* Dynamic liquidity allocation (e.g. shared collateral across markets)
* Position-based exposure (e.g. funding rates tied to net positioning)
...
* iAssets continue trading 24/7 on Injective, even when the mark price is not updating.
